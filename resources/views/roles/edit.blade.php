<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{route('roles.index')}}" class="bg-slate-700 text-sm rounded-md text-white px-2 py-2">Back</a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{route('roles.update', $role->id)}}" method="POST">
                        ...
                        <div>
                            ...
                            <button class="bg-slate-700 hover:bg-slate-700 text-sm rounded-md text-white px-5 py-3 ">Update</button>
                        </div>
                    </form>
                </div>
            </div>
